...
export default function CustomerPortal({path}:{path:string}){
  ...
  const headingDescription=q?`Current ${revisionTitle(q.revision)}. Review terms, ask a question, or accept when approval is complete.`:'Review quotations, follow deliveries, and open invoices.';
  return <>
